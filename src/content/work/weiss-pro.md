...
type: 'Ghost Theme'
year: '2020'
heroImage: '../../assets/img/work/weiss-pro.webp'
pubDate: 'Feb 26 2026'
---

## My First premium Ghost theme

As you can read in the title of this section, [Weiss Pro](https://ghost.org/themes/weisspro/) is my first premium [Ghost](https://ghost.org/) theme. After having launched an [open source theme](https://github.com/eddiesigner/liebling) I decided to create a premium one because the free one was very well received and has been used by many people so far, also because I gained experience and now I feel confident that I can create a product that people want to pay for, to tell the truth it took me a little work to overcome the fear of failure but now I can say that it was worth it.
