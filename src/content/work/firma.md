...
type: 'Ghost Theme'
year: '2020'
heroImage: '../../assets/img/work/firma.webp'
pubDate: 'Feb 27 2026'
---
...
1. Be able to adapt perfectly to the identity of any brand.
2. Offer the user a simple navigation and highlight the important elements from the rest.
3. Be accessible so that as many people as possible can consume the content without problems and offer a friendly user experience.
4. Offer a deep level of customization and be ready to be extended if desired.
